...
wt `
  ...
  split-pane -V cmd /k "cd /d $escapedPath && title barrel1 && timeout /t 3 /nobreak && make run-b1" `; `
  new-tab cmd /k "cd /d $escapedPath && title barrel2 && timeout /t 3 /nobreak && make run-b2" `; `
